...
def download_mturk_sample_conversations(n_runs, platform, min_results):
    ...
    download_mturk_sample_helper = partial(download_mturk_samples, platform, min_results)
...
def download_mturk_samples(platform=PLATFORM.TWITTER, min_results=20) -> list[DelabTree]:
    result = []
