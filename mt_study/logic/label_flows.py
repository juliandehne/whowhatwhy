...
def needs_moderation(flow: ConversationFlow):
    ...
    positive_requirements = c.is_conversation_0 and c.is_conversation_1 and c.is_conversation_2 and c.is_valid_conversation
    ...
    if c.needs_moderation is not None:
        return True
    else:
